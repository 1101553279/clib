...
#define LOG_RED COLOR_BACK_RED
#define LOG_YEL COLOR_BACK_YELL
#define LOG_GRN COLOR_BACK_GREN
#define logc(color, fmt, args...)  do{ printf(color fmt COLOR_FONT_NONE, ##args); fflush(stdout);} while(0)
